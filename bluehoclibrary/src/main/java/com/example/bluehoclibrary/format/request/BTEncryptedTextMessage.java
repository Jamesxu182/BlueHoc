...
public class BTEncryptedTextMessage extends BTBaseMessageFormat {
    private static final String METHOD = "encrypted_text";
    ...
    public BTEncryptedTextMessage(ArrayList<BTMember> to, String content) {
        super(METHOD, to);
        this.to = to;
